...
void	ft_load_textures(t_mlx *ptr)
{
	ptr->t->wall = mlx_xpm_file_to_image(ptr->mlx, "./xpm/wall_vines.xpm", &ptr->m->tile, &ptr->m->tile);
	ptr->t->path = mlx_xpm_file_to_image(ptr->mlx, "./xpm/ground.xpm", &ptr->m->tile, &ptr->m->tile);
